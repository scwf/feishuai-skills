...
Do not perform dubbing, TTS, voice cloning, WSL bridging, Windows-only Faster-Whisper-XXL execution, video summary, or visual frame analysis in this skill.
...
Install dependencies from `requirements.txt` in a normal Python environment:
