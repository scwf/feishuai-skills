...
| --- | --- | --- | --- |
| `agent-skill-card-extractor` | Extracts concise Chinese Agent skill cards from articles, links, repositories, or raw text. | You want to filter daily AI/agent information, judge whether a workflow is worth collecting, or append recommended cards to a personal Markdown skill library. | Produces a fixed-format Chinese skill card and uses a bundled append script to add recommended cards without overwriting existing library entries. |
